  ...
  const generateImage = async () => {
    if (form.prompt) {
      try {
        ...
        const response = await fetch('https://intellibot-vl66.onrender.com/api/v1/intellibot', {
          method: 'POST',
          headers: {
    ...
    <section className="max-w-7xl mx-auto">
      ...
      <form className="mt-16 max-w-3xl" onSubmit={handleSubmit}>
        <div className="flex flex-col gap-5">
          ...
          <div className="relative bg-white border border-[#63f7ff] text-gray-900 text-sm rounded-lg focus:ring-[#63f7ff] focus:border-blue-500 w-64 p-3 h-64 flex justify-center items-center">
            { form.photo ? (
              <img
                src={form.photo}
                alt={form.prompt}
        ...
        <div className="mt-10">
          ...
          <button
            type="submit"
            className="mt-3 text-black bg-white border-cyan-300/100 font-medium rounded-md text-sm w-full sm:w-auto px-5 py-2.5 text-center"
          >
